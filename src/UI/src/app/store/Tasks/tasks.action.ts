...
export const fetchtasklistFail = createAction(
  '[Data fetch tasklist failed',
  props<{error: string}>(),
);

// Add Data
export const addtasklist = createAction('[Data] Add tasklist', props<{newData: Task}>());
...
// Update Data
export const updatetasklist = createAction('[Data] Update tasklist', props<{updatedData: Task}>());
