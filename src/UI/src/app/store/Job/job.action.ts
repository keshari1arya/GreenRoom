...
export const fetchJoblistSuccess = createAction(
  '[Data] fetch Joblist success',
  props<{joblist: jobListModel[]}>(),
);
export const fetchJoblistFail = createAction(
  '[Data fetch Joblist failed]',
  props<{error: string}>(),
);

//  fetchJobgridData
export const fetchJobgridData = createAction('[Data] fetch Jobgrid');
export const fetchJobgridSuccess = createAction(
  '[Data] fetch Jobgrid success',
  props<{jobGrid: jobGridModel[]}>(),
);
export const fetchJobgridFail = createAction(
  '[Data fetch Jobgrid failed]',
  props<{error: string}>(),
);

//  fetchJobApplyData
export const fetchJobApplyData = createAction('[Data] fetch JobApply');
export const fetchJobApplySuccess = createAction(
  '[Data] fetch JobApply success',
  props<{JobApply: jobApplyModel[]}>(),
);
export const fetchJobApplyFail = createAction(
  '[Data fetch JobApply failed]',
  props<{error: string}>(),
);

// Add Data
export const addJoblist = createAction('[Data] Add Joblist', props<{newData: jobListModel}>());
...
// Delete Data
export const deleteJoblist = createAction('[Data] Delete Joblist', props<{id: string}>());
