...
export const fetchuserlistSuccess = createAction(
  '[Data] fetch userlist success',
  props<{UserListdata: userListModel[]}>(),
);
export const fetchuserlistFail = createAction(
  '[Data fetch userlist failed]',
  props<{error: string}>(),
);

// Add Data
export const adduserlist = createAction('[Data] Add userlist', props<{newData: userListModel}>());
...
// Delete Data
export const deleteuserlist = createAction('[Data] Delete userlist', props<{id: string}>());
