...
export const fetchchatSuccess = createAction(
  '[Data] fetch Chat success',
...
export const fetchchatMessageSuccess = createAction(
  '[Data] fetch ChatMessage success',
  props<{chatMessage: ChatUser[]}>(),
);
export const fetchchatMessageFail = createAction(
  '[Data fetch ChatMessage failed',
  props<{error: string}>(),
);
