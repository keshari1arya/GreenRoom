...
export const selectData = createSelector(selectDataState, (state: ChatState) => state.chat);
...
export const selectDataError = createSelector(selectDataState, (state: ChatState) => state.error);
