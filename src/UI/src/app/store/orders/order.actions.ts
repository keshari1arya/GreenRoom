...
// Add Data
export const addEcoOrders = createAction('[Data] Add Orders', props<{newData: OrdersModel}>());
...
// Delete Data
export const deleteEcoOrders = createAction('[Data] Delete Orders', props<{ids: string}>());
