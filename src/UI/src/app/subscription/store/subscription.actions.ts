...
export const SubscriptionSuccess = createAction("[Subscription] Subscription Success", props<{ subscriptions: SubscriptionDto[] }>());
...
export const subscriptionCreateSuccess = createAction("[Subscription] Subscription Create Success", props<{ subscriptionsId: number }>());

//subscription-update
export const updateSubscription = createAction("[Subscription] Update Subscription", props<{ subscriptions: UpdateSubscriptionCommand }>());
export const subscriptionUpdateSuccess = createAction("[Subscription] Subscription Update Success", props<{ subscriptionsId: number }>());