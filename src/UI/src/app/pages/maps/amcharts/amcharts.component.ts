...
export class AmchartsComponent {
  ...
  ngOnInit(): void {
    ...
    var Brazil = pointSeries.pushDataItem({latitude: -14.235, longitude: -51.9253});
    ...
    // Create point series
    var pointSeries = markerChart.series.push(am5map.MapPointSeries.new(markerRoot, {}));
    ...
    // Create point series
    var pointSeries = ImageChart.series.push(am5map.MapPointSeries.new(imageRoot, {}));
    ...
    var graticuleSeries = canadaChart.series.insertIndex(0, am5map.GraticuleSeries.new(root, {}));
    ...
    var backgroundSeries = canadaChart.series.unshift(am5map.MapPolygonSeries.new(canadaRoot, {}));
